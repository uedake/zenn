...
本記事の目標は、ノード名とノード名前空間について許されるフォーマットを理解すること、および完全修飾ノード名（ノードを一意に識別する為の文字列）との関係を理解することです。
...
そして完全修飾ノード名（fully qualified node name=ノード名前空間とノード名を結合した名前）は、システム全体でユニークである必要があります。
